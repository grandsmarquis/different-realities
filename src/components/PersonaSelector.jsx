...
const personaColors = {
  ...
  androidTvInbox: {
    bg: 'radial-gradient(ellipse 90% 70% at 18% 8%, #112566 0%, transparent 45%), linear-gradient(165deg, #040716 0%, #0a122e 45%, #050c20 100%)',
    accent: '#22d3ee',
    text: '#dbeafe',
  },
  vista: {
  ...
  pongMail: {
    bg: 'linear-gradient(160deg, #05080a 0%, #0a1810 45%, #020604 100%)',
    accent: '#39ff14',
    text: '#e8fff4',
  },
  htopMail: {
    bg: 'radial-gradient(circle at 12% 0%, rgba(20, 70, 42, 0.35) 0%, transparent 35%), linear-gradient(165deg, #050a08 0%, #0b1410 45%, #020604 100%)',
    accent: '#39ff88',
    text: '#d7ffe8',
  },
  jsonFileMail: {
    bg: 'linear-gradient(160deg, #0d0d14 0%, #1a1028 42%, #0f1620 100%)',
    accent: '#bd93f9',
    text: '#f8f8f2',
  },
  smurfFan: {
  ...
  misterBeast: {
    bg: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(34,197,94,0.35) 0%, transparent 55%), linear-gradient(160deg, #04060a 0%, #061b12 55%, rgba(251,191,36,0.85) 140%)',
    accent: '#22c55e',
    text: '#e6fffa',
  },
  god: {
  ...
  youDontKnowHowToRead: {
    bg: 'linear-gradient(160deg, #fbf3e6 0%, #eef2ff 55%, #fff7ed 100%)',
    accent: '#7c3aed',
    text: '#24160f',
  },
  emojiOnlyReader: {
  ...
  youtubeMail: {
    bg: 'linear-gradient(180deg, #0f0f0f 0%, #1a0505 40%, #0f0f0f 100%)',
    accent: '#ff0000',
    text: '#f1f1f1',
  },
  developer: {
  ...
  gitDiffMail: {
    bg: 'linear-gradient(165deg, #010409 0%, #0d1117 45%, #0a1628 100%)',
    accent: '#58a6ff',
    text: '#c9d1d9',
  },
  soonReplacedByAiDev: {
  ...
  stackoverflowMail: {
    bg: 'linear-gradient(165deg, #f4f6f8 0%, #fff5eb 45%, #e7ecf0 100%)',
    accent: '#f48024',
    text: '#242729',
  },
  calligraphy: {
    bg: 'radial-gradient(ellipse at 20% 0%, rgba(124,45,18,0.18) 0%, transparent 45%), linear-gradient(160deg, #fff7e6 0%, #f5f3ff 45%, #fde68a 100%)',
    accent: '#7c2d12',
    text: '#2a1a12',
  },
  popupChaos: {
    bg: 'linear-gradient(125deg, #1a0a28 0%, #4c1d95 28%, #b91c1c 55%, #ca8a04 82%, #0f172a 100%)',
    accent: '#fbbf24',
    text: '#fef3c7',
  },
  firstIpodBrowser: {
    bg: 'linear-gradient(180deg, #1a2e1a 0%, #0d1f0d 45%, #051005 100%)',
    accent: '#7fff7f',
    text: '#c8ffc8',
  },
  'counter-strike-16': {
    bg: 'linear-gradient(165deg, #3d3418 0%, #2a2210 42%, #1a1810 72%, #4a5c2a 100%)',
    accent: '#fbbf24',
    text: '#fef9c3',
  },
  firstIpad: {
    bg: 'linear-gradient(165deg, #e8e4dc 0%, #d4cfc4 38%, #c4b8a8 72%, #f5f0e8 100%)',
    accent: '#2563eb',
    text: '#1e293b',
  },
  swissPatriot: {
    bg: 'linear-gradient(145deg, #dc2626 0%, #ffffff 42%, #dc2626 100%)',
    accent: '#1e3a8a',
    text: '#0f172a',
  },
  year1400: {
    bg: 'linear-gradient(160deg, #2c1810 0%, #4a3020 45%, #1a0f08 72%, #8b6914 100%)',
    accent: '#d4af37',
    text: '#f5e6c8',
  },
  ukPrimeMinister: {
    bg: 'linear-gradient(165deg, #0f172a 0%, #1e293b 40%, #7f1d1d 88%, #0c1929 100%)',
    accent: '#fbbf24',
    text: '#f8fafc',
  },
  administrativeForm: {
    bg: 'linear-gradient(180deg, #f5f5f4 0%, #e7e5e4 45%, #d6d3d1 100%)',
    accent: '#1c1917',
    text: '#292524',
  },
  deathMetalLover: {
    bg: 'radial-gradient(ellipse 100% 80% at 50% 100%, #450a0a 0%, transparent 55%), linear-gradient(165deg, #050505 0%, #1a0505 50%, #000000 100%)',
    accent: '#ef4444',
    text: '#fecaca',
  },
  yakuzaBoss: {
    bg: 'linear-gradient(160deg, #0a0508 0%, #1a0a14 42%, #450a0a 88%, #0c0a0a 100%)',
    accent: '#f87171',
    text: '#fce7e7',
  },
  startupFounder: {
    bg: 'radial-gradient(ellipse 90% 60% at 90% 0%, rgba(99,102,241,0.25), transparent), linear-gradient(165deg, #0f0a1a 0%, #1e1b4b 45%, #312e81 100%)',
    accent: '#a78bfa',
    text: '#ede9fe',
  },
  aiChatbot: {
    bg: 'linear-gradient(155deg, #0c1222 0%, #1e1b4b 42%, #164e63 78%, #0f172a 100%)',
    accent: '#22d3ee',
    text: '#e0f2fe',
  },
  farmer: {
    bg: 'linear-gradient(165deg, #365314 0%, #422006 38%, #1e3a5f 72%, #14532d 100%)',
    accent: '#fbbf24',
    text: '#fef3c7',
  },
  africanTribeVillage: {
    bg: 'linear-gradient(165deg, #78350f 0%, #b45309 35%, #ea580c 65%, #1c1917 100%)',
    accent: '#fde68a',
    text: '#fffbeb',
  },
  mailMovie: {
    bg: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(251,191,36,0.2) 0%, transparent 50%), linear-gradient(168deg, #0c0a09 0%, #1c1917 50%, #0f0f0f 100%)',
    accent: '#fbbf24',
    text: '#fef3c7',
  },
  smartwatchMail: {
    bg: 'radial-gradient(circle at 50% 35%, rgba(34,211,238,0.12) 0%, transparent 45%), linear-gradient(165deg, #030712 0%, #0f172a 100%)',
    accent: '#22d3ee',
    text: '#e2e8f0',
  },
  pspMail: {
    bg: 'linear-gradient(155deg, #1e293b 0%, #334155 35%, #4c1d95 70%, #0f172a 100%)',
    accent: '#c4b5fd',
    text: '#f1f5f9',
  },
  matrixScreenMail: {
    bg: 'linear-gradient(180deg, #000000 0%, #001a0a 45%, #000505 100%)',
    accent: '#22c55e',
    text: '#86efac',
  },
  yogaTeacher: {
    bg: 'linear-gradient(165deg, #fef3c7 0%, #fde68a 35%, #a7f3d0 72%, #e0f2fe 100%)',
    accent: '#0d9488',
    text: '#134e4a',
  },
  snowWindowMail: {
    bg: 'linear-gradient(165deg, #e0f2fe 0%, #f0f9ff 42%, #bae6fd 78%, #f8fafc 100%)',
    accent: '#0284c7',
    text: '#0c4a6e',
  },
  prisonDirector: {
    bg: 'linear-gradient(165deg, #18181b 0%, #27272a 42%, #0f172a 100%)',
    accent: '#94a3b8',
    text: '#f1f5f9',
  },
  year1980: {
    bg: 'linear-gradient(165deg, #78350f 0%, #451a03 38%, #292524 72%, #1c1917 100%)',
    accent: '#f97316',
    text: '#ffedd5',
  },
  jungleDweller: {
    bg: 'linear-gradient(165deg, #052e16 0%, #14532d 40%, #166534 72%, #0f172a 100%)',
    accent: '#4ade80',
    text: '#ecfdf5',
  },
  youAreAFish: {
    bg: 'radial-gradient(ellipse 100% 70% at 50% 100%, rgba(6,182,212,0.35) 0%, transparent 50%), linear-gradient(168deg, #042f2e 0%, #0e7490 45%, #164e63 100%)',
    accent: '#22d3ee',
    text: '#ecfeff',
  },
  extremelyLazy: {
    bg: 'linear-gradient(165deg, #1c1917 0%, #292524 45%, #3f3f46 100%)',
    accent: '#a78bfa',
    text: '#e7e5e4',
  },
}
...
const personaFonts = {
  ...
  androidTvInbox: "'Space Grotesk', 'Outfit', sans-serif",
  ...
  pongMail: "'Orbitron', sans-serif",
  htopMail: "'Space Grotesk', 'IBM Plex Mono', monospace",
  jsonFileMail: "'Fira Code', monospace",
  smurfFan: "'Fredoka', sans-serif",
  princess: "'Great Vibes', cursive",
  barbieGirl: "'Lilita One', cursive",
  misterBeast: "'Bungee', cursive",
  god: "'Cinzel', serif",
  ...
  youDontKnowHowToRead: "'Permanent Marker', cursive",
  ...
  youtubeMail: "'Oswald', sans-serif",
  developer: "'JetBrains Mono', monospace",
  gitDiffMail: "'JetBrains Mono', 'Space Grotesk', monospace",
  ...
  stackoverflowMail: "'Source Sans 3', system-ui, sans-serif",
  calligraphy: "'Great Vibes', cursive",
  popupChaos: "'Bungee', cursive",
  firstIpodBrowser: "'VT323', monospace",
  'counter-strike-16': "'Black Ops One', cursive",
  firstIpad: "'Nunito', sans-serif",
  swissPatriot: "'Bebas Neue', sans-serif",
  year1400: "'UnifrakturMaguntia', cursive",
  ukPrimeMinister: "'Newsreader', serif",
  administrativeForm: "'Courier Prime', monospace",
  deathMetalLover: "'Metal Mania', 'Bebas Neue', sans-serif",
  yakuzaBoss: "'Noto Serif JP', serif",
  startupFounder: "'Syne', sans-serif",
  aiChatbot: "'Space Grotesk', sans-serif",
  farmer: "'Rye', serif",
  africanTribeVillage: "'Abril Fatface', serif",
  mailMovie: "'Bebas Neue', sans-serif",
  smartwatchMail: "'Orbitron', sans-serif",
  pspMail: "'Orbitron', sans-serif",
  matrixScreenMail: "'Share Tech Mono', monospace",
  yogaTeacher: "'Cormorant Garamond', serif",
  snowWindowMail: "'Fraunces', serif",
  prisonDirector: "'Oswald', sans-serif",
  year1980: "'Press Start 2P', monospace",
  jungleDweller: "'Patrick Hand', cursive",
  youAreAFish: "'Fredoka', sans-serif",
  extremelyLazy: "'Nunito', sans-serif",
}
      ...
      <div className="mx-auto flex w-full max-w-[1300px] flex-col items-center gap-10 px-5 sm:px-8 lg:px-10">
        ...
        <div className="w-full max-w-2xl text-center sm:max-w-3xl">
          ...
          <div className="space-y-5 text-sm leading-relaxed tracking-widest text-neutral-500 sm:space-y-6">
            <p>
              In the age of AI, creating interfaces is sometimes faster than searching for them. In the space of 6 hours, AI coded this {personas.length} mini websites for 20$. The goal is to show how the exact same data (mail inbox, weather, news, stocks) would look through the eyes of different people and devices. An experiment by{' '}
